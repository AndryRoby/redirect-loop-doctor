...
- Use the hosted tool at
  https://arling.sk/redirect-loop-doctor/ freely, for any
  purpose, personal or commercial, at no cost.
- Read the source of `index.html` / the diagnosis engine to understand
...
- Use the "Redirect Loop Doctor" name, the ARLing s. r. o.
